...
- `LLM_MODEL` - Default model to use (optional, defaults to `grok-4-2` if `GROK_API_KEY` is set)
- Examples: `claude-3-5-sonnet-20241022`, `gpt-4`, `gemini-pro`, `grok-4-2`
...
- Grok: `grok-4-2`, `grok-4-1-fast-reasoning`, `grok-4-1-fast-non-reasoning`, `grok-beta` (xAI)
